...
There's a moment when, after you've spent an hour editing a `docker-compose.yml`, reviewing environment variables, mounting volumes, you finally type `docker compose up -d` and all the containers come up green. The logs aren't spewing errors. The service responds in the browser.
