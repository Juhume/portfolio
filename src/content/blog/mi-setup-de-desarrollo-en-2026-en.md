...
I don't use Vim or Neovim. Nothing against them, but the learning curve doesn't pay off for my case. I don't use Notion or Obsidian for documenting code: a well-written README and clear comments are enough. I don't use ultrawide monitors, just two regular screens and done.
