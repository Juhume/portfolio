...
export const en: Translations = {
    ...
    about: {
        ...
        paragraphs: [
            'Currently working at BBVA on web and mobile products, technical support and platform evolution.',
        ...
        personal: [
            'I\'m from A Coruña and live in Madrid. I almost always wear headphones because I listen to music practically all the time, and I go to every concert I can.',
            'I studied Law, though the truth is that since I was a kid I was already tinkering with web pages, building personal sites and setting up Habbo servers to play with my friends.',
            'I also enjoy tracking planes on FlightRadar when I get distracted and trying to improve at DIY, though for now I\'m still better at building software than furniture.',
        ],
        principlesTitle: 'How I work',
        principles: [
            'Readability before cleverness',
            'Types where they add clarity and prevent bugs',
            'Every module with a clear responsibility',
            'Understand the system before changing it',
            'Maintainable solutions before flashy ones',
        ],
    },
    contact: {
        sectionNumber: '05',
