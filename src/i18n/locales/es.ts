...
export const es: Translations = {
    ...
    about: {
        ...
        principlesTitle: 'Mi forma de trabajar',
        principles: [
            'No me interesa solo que un producto funcione, sino que transmita cuidado, consistencia y una buena experiencia a quien lo usa',
            'Intento priorizar la legibilidad y la claridad por encima de soluciones innecesariamente complejas',
