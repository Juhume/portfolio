...
export const gl: Translations = {
    ...
    about: {
        ...
        paragraphs: [
            'Actualmente traballo en BBVA en produtos web e mobile, soporte técnico e evolución de plataforma.',
        ...
        personal: [
            'Son coruñés e vivo en Madrid. Case sempre levo cascos porque escoito música practicamente a todas horas, e vou a todos os concertos que podo.',
            'Estudei Dereito, aínda que a realidade é que desde pequeno xa andaba trasteando con páxinas web, montando sitios persoais e levantando servidores de Habbo para xogar cos meus amigos.',
            'Tamén me gusta pasar o tempo mirando avións en FlightRadar cando me distraio e intento mellorar no bricolaxe, aínda que polo de agora sigo montando mellor software que mobles.',
        ],
        principlesTitle: 'Como traballo',
        principles: [
            'Lexibilidade antes que cleverness',
            'Tipos onde aportan claridade e evitan bugs',
            'Cada módulo cunha responsabilidade clara',
            'Entender o sistema antes de cambialo',
            'Solucións mantibles antes que solucións vistosas',
        ],
    },
    contact: {
        sectionNumber: '05',
